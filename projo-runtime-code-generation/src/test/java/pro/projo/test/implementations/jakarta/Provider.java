...
//                                                                          //
package pro.projo.test.implementations.jakarta;

import jakarta.inject.Inject;
import pro.projo.annotations.Returns;

/**
* {@link pro.projo.test.implementations.jakarta.Provider} is a test interface
* that is used by {@link pro.projo.ProjoProviderTest}.
*
* @author Mirko Raner
**/
