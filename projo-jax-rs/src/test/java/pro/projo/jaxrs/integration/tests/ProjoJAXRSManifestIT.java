...
//                                                                          //
package pro.projo.jaxrs.integration.tests;
...
public class ProjoJAXRSManifestIT extends ManifestTest
{
    @Parameters(name="{0}")
    ...
    public ProjoJAXRSManifestIT(TestAttribute testAttribute) throws Exception
    {
        super("projo-jax-rs", testAttribute);
    }

    @Override
    public String expectedBundleName()
    {
        return "pro.projo.projo-jax-rs";
    }

    @Override
    public String expectedBundleSymbolicName()
    {
        return "pro.projo.projo-jax-rs; singleton:=true";
    }
    ...
    {
        return Collections.singleton("pro.projo.jaxrs.jersey.moxy");
    }
