...
* @author Mirko Raner
**/
public interface Factory<_Artifact_, _First_, $AdditionalTypeParameters> extends pro.projo.Factory
{
    /**
    ...
    **/
    _Artifact_ create(_First_ $argumentAndAdditionalParameters);
}
