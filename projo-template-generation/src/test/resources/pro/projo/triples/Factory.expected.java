...
/**
*
* The {@link pro.projo.triples.Factory} interface defines Projo's generic factory for objects with 3 fields.
*
...
public interface Factory<_Artifact_, _First_, _Second_, _Third_> extends pro.projo.Factory
{
    ...
    **/
    _Artifact_ create(_First_ first, _Second_ second, _Third_ third);
}
