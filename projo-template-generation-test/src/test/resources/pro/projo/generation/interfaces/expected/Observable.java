...
/* */
    ...
    <R> R as(ObservableConverter<T, ? extends R> converter);
    T blockingFirst();
    ...
    Observable<T> concatWith(SingleSource<? extends T> other);
    Observable<T> concatWith(MaybeSource<? extends T> other);
    Observable<T> concatWith(CompletableSource other);
    ...
    Observable<T> mergeWith(SingleSource<? extends T> other);
    Observable<T> mergeWith(MaybeSource<? extends T> other);
    Observable<T> mergeWith(CompletableSource other);
    ...
    <R> Observable<R> switchMapMaybe(Function<? super T, ? extends MaybeSource<? extends R>> mapper);
    <R> Observable<R> switchMapMaybeDelayError(Function<? super T, ? extends MaybeSource<? extends R>> mapper);
    <R> Observable<R> switchMapSingle(Function<? super T, ? extends SingleSource<? extends R>> mapper);
    <R> Observable<R> switchMapSingleDelayError(Function<? super T, ? extends SingleSource<? extends R>> mapper);
