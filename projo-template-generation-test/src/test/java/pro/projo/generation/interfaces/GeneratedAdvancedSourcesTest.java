...
/**
* {@link GeneratedAdvancedSourcesTest} is a parameterized test that checks that all files
* in {@code src/test/resources/pro/projo/generation/interfaces/advanced/expected} match their
