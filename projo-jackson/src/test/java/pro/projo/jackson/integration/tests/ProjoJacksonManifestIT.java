...
//                                                                          //
package pro.projo.jackson.integration.tests;
...
public class ProjoJacksonManifestIT extends ManifestTest
{
    @Parameters(name="{0}")
    ...
    public ProjoJacksonManifestIT(TestAttribute testAttribute) throws Exception
    {
        super("projo-jackson", testAttribute);
    }

    @Override
    public String expectedBundleName()
    {
        return "pro.projo.projo-jackson";
    }

    @Override
    public String expectedBundleSymbolicName()
    {
        return "pro.projo.projo-jackson; singleton:=true";
    }
    ...
    {
        return Collections.singleton("pro.projo.jackson");
    }
